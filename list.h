...
/* Returns the element at the given index. Starting index is 1. Returns -1 if index is invalid. */
elem list_get_elem_at(list_t *l, int index);

/* Returns the index at which the given element appears. Returns -1 if the element does not exist. */
